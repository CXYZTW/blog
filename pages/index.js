        ...
        <div className="mb-12 flex flex-col items-center gap-x-12 xl:flex-row">
          <div className="pt-6">
            ...
            <h2 className="prose pt-5 text-lg text-gray-600 dark:text-gray-300">
              {`Welcome to ${siteMetadata.description}. `}I am a D who is passionate about Data
              Science and Automation. In my free time, I like developing side projects and learning
              new technologies.
            </h2>
